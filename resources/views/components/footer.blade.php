<footer class="bg-blue-950 w-full relative overflow-hidden mt-20 py-16">
    <div class="container max-w-[1130px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between text-white">
        ...
        <div class="flex flex-col items-start gap-6 mb-10 md:mb-0 pl-4">
            ...
            <div class="flex gap-4 z-10">
                <a href="https://wa.link/6tn09n" target="_blank" class="w-8 h-8 flex shrink-0 cursor-pointer transition-transform transform hover:scale-110">
        ...
        <div class="flex flex-col items-start md:items-end gap-4 pl-4 md:pl-0">
            ...
            <p class="text-gray-400 text-left md:text-right max-w-[250px]">
                PT. Setia Primatama Semesta<br>
                Taman Tekno Bangunan Multi Guna Blok H 2 No.5<br>
                BSD Sektor XI - Tangerang 15314
            </p>
            <h2 class="font-bold text-lg flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
            ...
            <p class="text-gray-400 text-left md:text-right max-w-[250px]">
                ...
                Fax: (021) 756 3713<br>
                <a href="mailto:alghifari@setiaprimatamas.com" class="text-gray-300 hover:underline">alghifari@setiaprimatamas.com</a>
            </p>
        </div>
    </div>
